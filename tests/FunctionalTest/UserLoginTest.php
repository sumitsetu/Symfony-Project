...
class UserLoginTest extends WebTestCase
{
    ...
    {  
        ...
        $crawler = $this->client->request('POST', '/login', array('_username' => 'sumitsetu@yahoo.com', '_password' => "123456",  'user_login' => $csrfdata));
    ...
    public function testUserLoginUsingGet()
    {
        ...
        $data = array('_username' => 'sumitsetu@yahoo.com','_password' => '123456');
